...
// Tue May  6 12:20:54 2014 by ROOT version 5.27/06b
// from TTree latino/probe_tree
// found on file: /STORE/lucija/latinosTrees/Data_LooseLooseTypeI/latino_103_DoubleMuon2012A.root
//////////////////////////////////////////////////////////
...
#ifdef WZ2012Data_cxx
WZ2012Data::WZ2012Data(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/STORE/lucija/latinosTrees/Data_LooseLooseTypeI/latino_103_DoubleMuon2012A.root");
      if (!f) {
         f = new TFile("/STORE/lucija/latinosTrees/Data_LooseLooseTypeI/latino_103_DoubleMuon2012A.root");
      }
...
WZ2012Data::~WZ2012Data()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t WZ2012Data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WZ2012Data::LoadTree(Long64_t entry)
{
...
void WZ2012Data::Init(TTree *tree)
{
...
void WZ2012Data::Show(Long64_t entry)
{
...
Int_t WZ2012Data::Cut(Long64_t entry)
{
