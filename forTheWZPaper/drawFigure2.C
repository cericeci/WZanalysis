...
const Float_t xs7eval[] = {23.00, 19.67, 19.81, 21.02, 20.76};
const Float_t xs7stat[] = { 3.10,  2.73,  2.60,  2.30,  1.32};
const Float_t xs7syst[] = { 1.39,  1.50,  1.55,  1.47,  1.13};
const Float_t xs7lumi[] = { 0.51,  0.43,  0.44,  0.46,  0.46};

const Float_t xs8eval[] = {24.67, 22.26, 23.80, 24.81, 23.89};
const Float_t xs8stat[] = { 1.92,  1.62,  1.52,  1.29,  0.81};
const Float_t xs8syst[] = { 1.73,  2.07,  2.38,  2.33,  1.34};
const Float_t xs8lumi[] = { 0.64,  0.58,  0.62,  0.65,  0.64};
