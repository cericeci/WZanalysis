...
// drawFigure3
//------------------------------------------------------------------------------
void drawFigure5_rev(Int_t logy = 0)
{
  ...
  TH1F * allmcbg = ZZ->Clone("histo_allmcbg");
  //  allmcbg->Add(Zgamma);
  //  allmcbg->Add(WV);
  //  allmcbg->Add(VVV);
  ...
  if (logy)
    {
      ...
      DrawTLegend(x0,        y0 + 1.*(_yoffset+0.001), fakes,    " fake leptons",                      "f");
      DrawTLegend(x0,        y0,                       allmcbg,  " MC bg",                             "f");
  ...
  else
    {
      ...
      DrawTLegend(x0, y0 - 2.*(_yoffset+0.001), WZ,       " WZ",                                "f");
      DrawTLegend(x0, y0 - 3.*(_yoffset+0.001), fakes,    " fake leptons",                      "f");
      DrawTLegend(x0, y0 - 4.*(_yoffset+0.001), ZZ,       " MC bg",                             "f");
