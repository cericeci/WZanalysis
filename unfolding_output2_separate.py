...
linesMain= open("outMain.txt", 'r').read().split('\n')
...
for i in range(0,len(linesMain)):
    ...
    if (len(main_values)>1):
        ...
        error1_1=float(error1_values[1])
        error2_1=float(error2_values[1])
        error3_1=float(error3_values[1])
        mainExp1=seeExponent(main_values[1])
        error1Exp1=seeExponent(error1_values[1])
        error2Exp1=seeExponent(error2_values[1])
        error3Exp1=seeExponent(error3_values[1])
