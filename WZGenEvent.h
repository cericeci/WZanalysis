...
// Wed Apr 16 14:17:56 2014 by ROOT version 5.32/00
// from TTree latino/probe_tree
// found on file: ../mc/NoSkim/step3all/latinowz_step3NoFilter-1.root
//////////////////////////////////////////////////////////
...
WZGenEvent::WZGenEvent(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../mc/NoSkim/step3all/latinowz_step3NoFilter-1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../mc/NoSkim/step3all/latinowz_step3NoFilter-1.root");
      }
...
void WZGenEvent::Show(Long64_t entry)
{
...
Int_t WZGenEvent::Cut(Long64_t entry)
{
